...
const LogisticsReceipt: React.FC<LogisticsReceiptProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white border border-gray-300 p-4 font-sans text-sm">
        ...
        <div className="flex border-b border-black">
          ...
          <div className="w-1/4 border-r border-black p-2">
            <div className="flex items-center">
              <div className="w-16 h-16 bg-blue-900 flex items-center justify-center text-white p-1">
                <div className="relative w-full h-full">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-lg font-bold">JAI'Z</span>
                  </div>
              ...
              <div className="ml-2">
                <div className="text-red-600 font-bold">JAI'Z LOGISTICS INC.</div>
          ...
          <div className="w-1/4 border-r border-black p-2">
            <div className="text-center font-bold">INTERNATIONAL</div>
            <div className="flex justify-around mt-1">
              <div className="flex items-center">
                <div className="border border-black w-4 h-4 mr-1"></div>
                <span>DOX</span>
              </div>
              <div className="flex items-center">
                <div className="border border-black w-4 h-4 mr-1"></div>
            ...
            <div className="text-center font-bold mt-2">DOMESTIC</div>
            <div className="flex justify-around mt-1">
              <div className="flex items-center">
                <div className="border border-black w-4 h-4 mr-1"></div>
                <span>DOX</span>
          ...
          {/* Mode of Transport */}
          <div className="w-1/4 border-r border-black p-2">
            <div className="text-center font-bold mb-2">MODE OF TRANSPORT</div>
          ...
          <div className="w-1/4 p-2 flex flex-col justify-center items-center">
            <div className="text-xl font-bold">{receiptNumber}</div>
            <div className="mt-2 w-full flex justify-between">
              <div className="text-red-600">DATE</div>
              <div className="border-b border-black px-2">{date}</div>
            </div>
          </div>
        </div>
            ...
            <div className="flex mt-4">
              ...
              <div className="w-2/3 border border-black p-1">
                ...
                {gstInfo.gstinTaxPayableInfo.map((info, index) => (
                  <div key={index} className="font-bold">{info}</div>
                ))}
              </div>
            </div>
          </div>
              ...
              <div className="flex mt-2">
                ...
                <div className="w-1/3 flex flex-col items-center justify-center">
                  <div className="flex items-center mb-2">
                    <div className={`border border-black w-4 h-4 mr-1 ${billInfo.paymentMode === "PAID" ? "bg-black" : ""}`}></div>
                    <span>PAID</span>
                  </div>
                  <div className="flex items-center mb-2">
                    <div className={`border border-black w-4 h-4 mr-1 ${billInfo.paymentMode === "TO PAY" ? "bg-black" : ""}`}></div>
                    <span>TO PAY</span>
                  </div>
                  <div className="flex items-center">
                    <div className={`border border-black w-4 h-4 mr-1 ${billInfo.paymentMode === "CREDIT" ? "bg-black" : ""}`}></div>
                    <span>CREDIT</span>
                  </div>
                </div>
                <div className="w-1/3"></div>
      ...
      {/* Shipper Copy Tag */}
      <div className="absolute top-0 right-0 -rotate-90 origin-bottom-right text-xs transform translate-y-12 -translate-x-4 bg-white px-4 border border-black">
        SHIPPER COPY
      </div>
    </div>
  );
