...
export default function PermissionManager() {
  ...
  const groupedFeatures = FEATURE_IDS.reduce((acc, featureId) => {
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Role: <Badge variant="outline" className="capitalize">{selectedUser.role}</Badge>
                      {' '}•{' '}
            ...
            <Card>
              <CardContent className="flex items-center justify-center h-[600px]">
                <div className="text-center">
                  <div className="text-muted-foreground">Select a user to manage their permissions</div>
                </div>
              </CardContent>
            </Card>
          )}
