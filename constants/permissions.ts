...
export const PERMISSION_FEATURES = {
  ...
  Attendance: ['FEATURE_ATTENDANCE_VIEW', 'FEATURE_ATTENDANCE_MANAGE'],
  ...
  Ratecard: ['FEATURE_RATECARD_VIEW', 'FEATURE_RATECARD_EDIT'],
  Reports: ['FEATURE_REPORTS_VIEW', 'FEATURE_REPORTS_EXPORT'],
